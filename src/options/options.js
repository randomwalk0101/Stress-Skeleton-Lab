...
const fields = ["pronunciationProvider", "openaiApiKey", "openaiModel", "geminiApiKey", "geminiModel", "localTtsEndpoint", "minTextLength", "maxPageItems", "pronunciationAnalyzer"];
let settings = {};
